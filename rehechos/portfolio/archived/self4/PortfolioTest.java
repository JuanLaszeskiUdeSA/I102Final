...
public class PortfolioTest {
  ...
  @Test void testBalanceOnNewAccount() {
    assertEquals( 0, new portfolio4.Account().balance() );
  }

  @Test void testBalanceAfterADeposit() {
    assertEquals( 10, new portfolio4.Account().deposit( 10 ).balance() );
  }
  
  @Test void testBalanceAfterAWithdraw() {
    portfolio4.Account account = new portfolio4.Account();
    account.deposit( 10 )
           .withdraw( 5 );
  ...
  @Test void testReportAfterADeposit() {
    assertEquals( "Deposit: 10\n" +
                  "Balance: 10",
                  new portfolio4.Account().deposit( 10 ).report() );
  }
